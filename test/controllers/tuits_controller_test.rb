...
class TuitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tuit" do
    assert_difference("Tuit.count") do
      post tuits_url, params: { tuit: { content: @tuit.content, created: @tuit.created, description: @tuit.description, friends_count: @tuit.friends_count, location: @tuit.location, user_name: @tuit.user_name } }
    end
  ...
  test "should update tuit" do
    patch tuit_url(@tuit), params: { tuit: { content: @tuit.content, created: @tuit.created, description: @tuit.description, friends_count: @tuit.friends_count, location: @tuit.location, user_name: @tuit.user_name } }
